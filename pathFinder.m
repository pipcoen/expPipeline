...
processedFolder = 'E:\Dropbox (Neuropixels)\subjectData\ProcessedData\';
...
switch lower(pathType)
    case 'block'; pathOut = [expInfo subjectPath expRef '_Block'];
    case 'timeline'; pathOut = [rawBlock expRef '_Timeline'];
    case 'parameters'; pathOut = [rawBlock expRef '_parameters'];
