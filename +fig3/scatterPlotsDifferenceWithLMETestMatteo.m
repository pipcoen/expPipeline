function scatterPlotsDifferenceWithLMETestMatteo(opt)
...
for targSite = 1:2
    ...
    hold on
    tDatN = globalReacN(:,targSite,:,1);
    tDatL = globalReacL(:,targSite,:,1);
    ...
    legendCell = [siteOrd{targSite} 'Contra'];
    text(1,max(ylim)*1.1,legendCell, 'fontsize', 10)
end
fName = [sName 'Diff_Matteo'];
