...
leftCoherentInitialConditions = uniqueConditions((uniqueConditions(:,end)<0.5&uniqueConditions(:,5)>0&uniqueConditions(:,4)>0) | (uniqueConditions(:,5)>0&uniqueConditions(:,4)==0) | (uniqueConditions(:,5)==0&uniqueConditions(:,4)==0&uniqueConditions(:,2)<0) ,:);
rightCoherentInitialConditions = uniqueConditions((uniqueConditions(:,end)>0.5&uniqueConditions(:,5)>0&uniqueConditions(:,4)>0) | (uniqueConditions(:,4)>0&uniqueConditions(:,5)==0) | (uniqueConditions(:,5)==0&uniqueConditions(:,4)==0&uniqueConditions(:,2)>0),:);
