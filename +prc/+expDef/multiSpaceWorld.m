...
zeroConditions = uniqueConditions(all(uniqueConditions==0 | isinf(uniqueConditions),2),:);
...
rightInitialConditions = [rightInitialConditions; uniqueConditions(~ismember(uniqueConditions, [zeroConditions; leftInitialConditions], 'rows'),:)];
