...
switch lower(dataTag{1})
    case {'behavior'; 'behaviour'}
        switch subjectID{1}
            ...
            case 'PC043'; dateRange = {'2019-03-06:2019-03-29'}; %Issues with eye after this point
            ...
            otherwise, dateRange = dataTag;
                %PC022 dateRange = {'2017-11-02:2017-11-21'}; %Data without any inactivation, but fewer trials
        end
    case 'aud5'
        switch subjectID{1}
