...
paths2Add = {'rawBlock'; 'rawParams'; 'serverProbeData';'serverTimeline'; 'galvoLog'; 'serverFolder'; 'processedData'; 'kilosortOutput'};
fieldNames = {'rawBlock'; 'rawParams'; 'rawProbeData'; 'rawTimeline'; 'galvoLog'; 'serverFolder'; 'processedData'; 'kilosortOutput'};
