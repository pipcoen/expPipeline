...
paths2Add = {'rawBlock'; 'rawParams'; 'serverProbeData';'serverTimeline'; 'serverFusi'; 'galvoLog'; 'serverFolder'; 'processedData'; 'kilosortOutput'};
fieldNames = {'rawBlock'; 'rawParams'; 'rawProbeData'; 'rawTimeline'; 'rawFusiData'; 'galvoLog'; 'serverFolder'; 'processedData'; 'kilosortOutput'};
