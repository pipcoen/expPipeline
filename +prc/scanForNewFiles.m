...
includedMice = {'PC005'; 'PC006'; 'PC009'; 'PC010'; 'PC011'; 'PC012'; 'PC013'; 'PC014'; 'PC015'; 'PC016'; 'PC017'; 'PC018';'PC019';'PC020'; 'PC021'; 'PC022'; 'PC023'};
startedDates = {'', ''};
retiredDates = {...
    'PC005' '2017-07-28'; ...
    'PC006' '2017-07-28'; ...
...
for i = 1:length(newBlocks)
    ...
    if exist(prc.pathFinder('galvoLog', subject, expDate, sessionNum), 'file')
        expList(end).gavloLog = prc.pathFinder('galvoLog', subject, expDate, sessionNum);
    else
