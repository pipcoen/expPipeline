...
if ~exist('synInfo', 'var') || isempty(synInfo); synInfo = [0 2]; end
...
if zipComp; fprintf('Running on Zip so will sync local folder and server... \n');
    prc.syncfolder(fileparts(prc.pathFinder('expList')), '\\zserver.cortexlab.net\lab\Share\Pip\ProcessedData\', synInfo(2)); end
...
if zipComp; prc.syncfolder(fileparts(prc.pathFinder('expList')), '\\zserver.cortexlab.net\lab\Share\Pip\ProcessedData\', synInfo(2)); end
end