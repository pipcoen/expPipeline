function runKilosortSpikeGLX(rootZ,rootH,chanMapFile)
...
pathToYourConfigFile = 'D:\Dropbox (Personal)\XMatlabProg\GitHub\Kilosort2\configFiles_kilosort2_Flora'; % take from Github folder and put it somewhere else (together with the master_file)
