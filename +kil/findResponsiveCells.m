...
elseif size(eventTimes,2) == 1 && length(unique(sessionIDs)) == 1; eventTimes = [eventTimes eventTimes*0+unique(sessionIDs)];
elseif size(eventTimes,2) == 1; eventTimes = [eventTimes eventTimes*0+1];
end
